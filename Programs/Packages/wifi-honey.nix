{ stdenv, lib, makeWrapper, screen, iproute2, aircrack-ng, procps, kmod, util-linux, wirelesstools, fetchFromGitLab }:
...
stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    makeWrapper $out/wifi_honey.sh $out/bin/wifi-honey --set PATH "$PATH:${lib.makeBinPath [ aircrack-ng wirelesstools screen iproute2 procps kmod util-linux]}"
